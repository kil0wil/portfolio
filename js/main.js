...
//skills page
function mySkill() {
    document.getElementById("content").innerHTML = "<iframe src='http://www.puddanz.com'style='height:200px;width:300px;'title='description'><br /><iframe src='http://www.thrive-branding.com'style='height:200px;width:300px;'title='description'>";
